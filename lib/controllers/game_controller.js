      ...
      return {
        ...
        public_info: PlayerCards.find({}, {
          transform: function(player_cards) {
            ...
            if (player_cards.coin_tokens > 0) {
              public_info.coin_tokens = player_cards.coin_tokens
            }
            ...
            if (_.size(player_cards.projects) > 0) {
              public_info.projects = player_cards.projects
            }
